...
BuildConsole %1.vcproj /cfg="Release|Win32" /Rebuild /NoLogo 				 /LINK_ADD="/OUT:"%LibName%Mt.lib""
BuildConsole %1.vcproj /cfg="Release|Win32" /Rebuild /NoLogo /CL_REM="/MT" /CL_ADD="/MD" /LINK_ADD="/OUT:"%LibName%Dll.lib""
BuildConsole %1.vcproj /cfg="Release|Win32" /Clean /NoLogo 
