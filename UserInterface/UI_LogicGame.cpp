...
//#include "..\Network\DW_interface.h" // @Hallkezz
...
void UI_LogicDispatcher::handleInGameChatString(const char* txt)
{
...
void UI_LogicDispatcher::handleSystemMessage(const char* str)
{
	XBuffer msg;
	msg < UI_Dispatcher::instance().systemMessageColor() < str < "&>";
	netCenter().handleChatString(msg.c_str());
