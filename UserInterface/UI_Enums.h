...
enum UI_InputEventID // HINT! новые добавлять только после UI_INPUT_MOUSE_WHEEL_DOWN, иначе не влезет в тип ActionMode
{
...
enum UI_ControlActionEvent // биты для ActionMode
{
...
enum UI_UserSelectEvent // отборка UI_ControlActionEvent для серилизации
{
...
enum UI_ControlUnitListType
{
	...
	UI_UNITLIST_SQUAD,
	UI_UNITLIST_SQUADS_IN_WORLD,
	UI_UNITLIST_PRODUCTION,
	UI_UNITLIST_PRODUCTION_COMPACT,
...
enum UI_ControlActionID
{
	...
	/// подсказка к этому контролу при наведении
	UI_ACTION_HOVER_INFO,
	/// привязать к объекту на мире
	UI_ACTION_LINK_TO_ANCHOR,
	/// привязать к мыше
	UI_ACTION_LINK_TO_MOUSE,
	/// привязать координаты к родительскому объекту
	UI_ACTION_LINK_TO_PARENT,
	/// горячая клавиша
	UI_ACTION_HOT_KEY,
	...
	UI_ACTION_INET_DIRECT_JOIN_GAME,
	...
	/// применение действия к юниту из текущего контрола
	UI_ACTION_CONTEX_APPLY_CLICK_MODE,
	/// отмена действия
	UI_ACTION_CANCEL,
	/// привязка к юниту
	/// кнопка видна, когда заселекчен определённый юнит
	UI_ACTION_BIND_TO_UNIT,
	// когда навели на определенного юнита
	UI_ACTION_BIND_TO_HOVERED_UNIT,
	/// привязка к существованию юнита на мире
	UI_ACTION_UNIT_ON_MAP,
	/// привязка к существованию сквада на мире
	UI_ACTION_SQUAD_ON_MAP,
	...
	/// отображение прогресса производства юнита
	UI_ACTION_PRODUCTION_PROGRESS,
	/// отображение прогресса производства параметров
	UI_ACTION_PRODUCTION_PARAMETER_PROGRESS,
	/// отображение прогресса текущего производства
	UI_ACTION_PRODUCTION_CURRENT_PROGRESS,
	/// включить оружие
	UI_ACTION_ACTIVATE_WEAPON,
	/// выключить оружие
	UI_ACTION_DEACTIVATE_WEAPON,
	/// отображение режима оружия
	UI_ACTION_WEAPON_STATE,
	...
	/// переключить рисование воды
	UI_ACTION_MINIMAP_DRAW_WATER,
	/// имя для интернета
	UI_ACTION_INET_NAME,
	...
	/// ввод адреса сервера для прямого соединения
	UI_ACTION_INET_DIRECT_ADDRESS,
	...
	/// установить режим работы инвентаря быстрого доступа
	UI_ACTION_INVENTORY_QUICK_ACCESS_MODE
};
...
enum UI_MinimapSymbolID
{
	...
	UI_MINIMAP_SYMBOL_UNIT_WAITING
};
...
enum UI_ClickModeID
{
	UI_CLICK_MODE_NONE,
    UI_CLICK_MODE_MOVE,
	UI_CLICK_MODE_ASSEMBLY,
	UI_CLICK_MODE_ATTACK,
	UI_CLICK_MODE_PLAYER_ATTACK,
...
enum UI_InventoryType
{
	UI_INVENTORY,				/// просто инвентарь, "карман"
	UI_INVENTORY_EQUIPMENT,				/// снаряжение
	UI_INVENTORY_QUICK_ACCESS		/// снаряжение с активацией, "пояс"
};

/// режимы работы снаряжения быстрого доступа
enum UI_QuickAccessMode {
	UI_INVENTORY_QUICK_ACCESS_OFF, /// быстрый доступ выключен, работает как обычный инвентарь
	UI_INVENTORY_QUICK_ACCESS_ON	/// быстрый доступ включен, по клику снаряжение активируется
};
