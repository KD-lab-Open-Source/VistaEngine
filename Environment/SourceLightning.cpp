...
Vect3f SourceLightning::setHeight(int x, int y, int h){
	return Vect3f(x, y, vMap.getVoxelW(x, y)+h);
}
...
void SourceLightning::showEditor() const
{
	...
	if(!targetInZone || !turnOfByTarget_)
		FOR_EACH(light_ends_, it){
			Vect3f v = *it;
			gb_RenderDevice->DrawLine(v + Vect3f(-2.0f, 0.0f, 0.0f), v + Vect3f(2.0f, 0.0f, 0.0f), YELLOW);
			gb_RenderDevice->DrawLine(v + Vect3f(0.0f, -2.0f, 0.0f), v + Vect3f(0.0f, 2.0f, 0.0f), YELLOW);
			gb_RenderDevice->DrawLine(v + Vect3f(0.0f, 0.0f, -2.0f), v + Vect3f(0.0f, 0.0f, 2.0f), YELLOW);
		}
	
	FOR_EACH(strike_ends_, it){
		Vect3f v = *it;
		gb_RenderDevice->DrawLine(v + Vect3f(-5.0f, 0.0f, 0.0f), v + Vect3f(5.0f, 0.0f, 0.0f), RED);
		gb_RenderDevice->DrawLine(v + Vect3f(0.0f, -5.0f, 0.0f), v + Vect3f(0.0f, 5.0f, 0.0f), RED);
		gb_RenderDevice->DrawLine(v + Vect3f(0.0f, 0.0f, -5.0f), v + Vect3f(0.0f, 0.0f, 5.0f), RED);
	}
}
...
void SourceLightning::showDebug() const
{
	...
	if(!targetInZone || !turnOfByTarget_)
		FOR_EACH(light_ends_, it){
			Vect3f v = *it;
			show_line(v + Vect3f(-3.0f, 0.0f, 0.0f), v + Vect3f(3.0f, 0.0f, 0.0f), YELLOW);
			show_line(v + Vect3f(0.0f, -3.0f, 0.0f), v + Vect3f(0.0f, 3.0f, 0.0f), YELLOW);
			show_line(v + Vect3f(0.0f, 0.0f, -3.0f), v + Vect3f(0.0f, 0.0f, 3.0f), YELLOW);
		}

	FOR_EACH(strike_ends_, it){
		Vect3f v = *it;
		show_line(v + Vect3f(-5.0f, 0.0f, 0.0f), v + Vect3f(5.0f, 0.0f, 0.0f), RED);
		show_line(v + Vect3f(0.0f, -5.0f, 0.0f), v + Vect3f(0.0f, 5.0f, 0.0f), RED);
		show_line(v + Vect3f(0.0f, 0.0f, -5.0f), v + Vect3f(0.0f, 0.0f, 5.0f), RED);
	}
