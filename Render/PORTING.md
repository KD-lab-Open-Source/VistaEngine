...
| 7 | **`cEnvironmentEarth`** | `Water/Water.cpp` | The ground plane drawn under the water out to the horizon. The horizon fog *ring* it sat behind is ported — #8 — so this is the remaining half of the map-edge gap. |
