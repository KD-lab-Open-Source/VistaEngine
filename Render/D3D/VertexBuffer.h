...
class RENDER_API cVertexBufferInternal
{
protected:
	sPtrVertexBuffer vb;
	int numvertex;
...
class RENDER_API cQuadBufferInternal:protected cVertexBufferInternal
{
	BYTE* start_vertex;
	int vertex_index;
public:
