...
struct FurInfo
{
	...
	string texture; //�������� ������
	string normal; //RGB - ����������� ������ � tangent space. A - ������ ������.
...
struct StaticMaterial
{
	...
	{	/* texture map in 3dSMAX */
		...
		TEXMAP_SP					=	2,   // specular					tex_specularmap (��� ����� ������)
...
struct StaticVisibilitySet
{
	...
	StaticVisibilityGroups visibilityGroups;//�� ����� ����� ������
