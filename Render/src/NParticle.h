...
public:
	...
	CVectVect3f begin_position; //������������� �� 3D ������ for EMP_3DMODEL_INSIDE
	CVectVect3f normal_position;//������������� �� 3D ������  for EMP_3DMODEL_INSIDE
...
public:
	...
	bool use_light;//��������� ������, ������ ��� EMP_3DMODEL,EMP_3DMODEL_INSIDE. 
				//������������ �� ������� ����������� ��������� diffuse � ambient.
	...
	KeysFloat	  p_gravity;
	bool angle_by_center;//�� ����� ������ ������� true, ���� planar=false
...
public:
	int cur_one_pos;//������ � begin_position
...
protected:
	...
	// ���� ���������� EffectBeginSpeed � EffectBeginSpeedMatrix ����� ������� ����������
	// �� ����� ������� � ����� �������� �� EmitterKeyInt
...
*/
	...
	bool SetFreeOrCycle(int index_particle);//����������, ������� �� ������� �������
...
public:
	...
	void SetFunctorGetZ(FunctorGetZ* func);//�������� ������� addref,release
...
protected:
	...
	void Add(cEmitterInterface*);//��������������, ��� ������� ��� ����������������
	c3dx* model;
	const MatXf& GetCenter3DModel();
	vector<Vect3f> begin_position;//������������� �� 3D ������
	vector<Vect3f> normal_position;//������������� �� 3D ������
