...
private:
	...
	Vect2f w2m(const Vect2f& v) { return Vect2f(float(w2m(v.x)), float(w2m(v.y))); }
	...
	virtual void Draw();
	virtual void Draw(BYTE transparent);
	virtual void CreateFFDData();
	virtual void DeleteFFDData();
};
