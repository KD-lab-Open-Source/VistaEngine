...
const int C3DX_MATERIAL_STATIC_FURINFO=411;
...
const int C3DX_LEAVES=1500;
const int C3DX_LEAF=1501;
const int C3DX_LEAF_HEAD=1502;
const int C3DX_LEAF_TEXTURE=1503;
