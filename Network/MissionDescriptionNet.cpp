...
void MissionDescriptionNet::clearAllPlayerStartReady()
{
	setChanged();
	for(unsigned int i=0; i<NETWORK_PLAYERS_MAX; i++){
...
bool MissionDescriptionNet::isAllRealPlayerStartReady()
{
	bool result=1;
	for(unsigned int i=0; i<playersAmountMax(); i++){
		if(slotsData[i].realPlayerType==REAL_PLAYER_TYPE_PLAYER)
...
bool MissionDescriptionNet::isAllRealPlayerGameLoaded()
{
	bool result=1;
	//for(unsigned int i=0; i<NETWORK_PLAYERS_MAX; i++){
...
void MissionDescriptionNet::clearAllPlayerGameLoaded()
{
	setChanged();
	for(unsigned int i=0; i<NETWORK_PLAYERS_MAX; i++){
...
int MissionDescriptionNet::getUniquePlayerClan()
{
	int i, c;
