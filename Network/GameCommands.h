...
class netCommand4G_ForcedDefeat : 
	public netCommandGameClonator<netCommand4G_ForcedDefeat, NETCOM_4G_ID_FORCED_DEFEAT>
{
public:
...
class netCommand4G_UnitCommand : 
	public netCommandGameClonator<netCommand4G_UnitCommand, NETCOM_4G_ID_UNIT_COMMAND>
{
public:
...
class netCommand4G_UnitListCommand : 
	public netCommandGameClonator<netCommand4G_UnitListCommand, NETCOM_4G_ID_UNIT_LIST_COMMAND>
{
public:
	netCommand4G_UnitListCommand(const UnitInterfaceList& unitList, const UnitCommand& unitCommand);
...
class netCommand4G_PlayerCommand : 
	public netCommandGameClonator<netCommand4G_PlayerCommand, NETCOM_4G_ID_PLAYER_COMMAND>
{
public:
...
class netCommand4G_Event : 
	public netCommandGameClonator<netCommand4G_Event, NETCOM_4G_ID_EVENT>
{
public:
