...
// Attributes
	bool ModelCamera;
	bool Camera43;
	float current_time_light;
	bool need_time_light;
public:
	bool& IsModelCamera(){return ModelCamera;}
	bool& IsCamera43(){return Camera43;}
	bool& NeedTimeLight(){return need_time_light;}
	float& time_light(){return current_time_light;}
// Operations
public:
...
public:
	...
	class CTabDialog	*m_pHierarchyObj;
