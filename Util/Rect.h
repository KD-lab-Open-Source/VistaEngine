...
struct Rect
{
	...
	inline ScalarType left () const { return left_; }
	inline ScalarType top () const { return top_; }
	inline ScalarType width () const { return width_; }
	inline ScalarType height () const { return height_; }

	VectType left_top() const { return VectType(left_, top_); }
	VectType right_top() const { return VectType(left + width_, top_); }
	...
	inline ScalarType right () const { return left_ + width_; }
	inline ScalarType bottom () const { return top_ + height_; }
	...
	*/
	...
	inline VectType   center () const { return VectType (left_ + width_ / ScalarType(2),
														top_ + height_ / ScalarType(2)); }
	/// Возвращает размер прямоугольника.
	inline VectType   size () const { return VectType (width_, height_); }

	// сеттеры:
	inline void       left (ScalarType _left) { left_ = _left; }
	inline void       top (ScalarType _top) { top_ = _top; }
	inline void       width (ScalarType _width) { width_ = _width; }
	inline void       height (ScalarType _height) { height_ = _height; }

	// сеттеры (вычисляющие):
	inline void       right (ScalarType _right) { left_ = _right - width_; }
	inline void       bottom (ScalarType _bottom) { top_ = _bottom - height_; }
	...
	*/
	...
	inline void       size (const VectType& _size) { width_ = _size.x; height_ = _size.y; }
	...
	*/
	...
	// TODO: для реализации лучше ввести класс Range!!!
	inline RectType   intersection (const RectType& _rect)
	{
	...
	*/
	...
	inline std::vector<VectType> to_polygon () const
	{
