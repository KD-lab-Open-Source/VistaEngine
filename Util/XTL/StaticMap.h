/**************************************************************************************************************************
* ��������� StaticMap �� ���� std::vector � ����������� ����������� 
* std::map, ���������� ������������ StaticMap<int, int>	� std::map<int, int> 
* ��� ������� 100, 1000, 10000 ���������:
* -------------------------------
* |  Timing:          |  rate % |
* -------------------------------
...
!!!! ��� ��������� ������� ���������� ������� ��������� ��� StaticMap<string, int>	� std::map<string, int> 
     � ������, ����� string �������� ��������� ������. ����� � ������������ �� P4 2.8 Ghz.
* -----------------------------
* |  Timing:          |  ms   |
* -----------------------------
...
����� ������ � map � StaticMap �������� ���������� ��� � ������ <int,int>, ��� � � ������ <string,int>. 
����� - ������ ������ ������ ���������������� �� ��������,
		�� ������� ������������ �� �������� �������������.
***************************************************************************************************************************/
...
public:
	...
	const mapped_type& operator[](const key_type& key) const {
		...
		xassert(!(vi==MapVector.end() || (key_comp()(key, vi->first))) && "�� ������ ������� � const-operator[]");
		return (*vi).second;
	}
