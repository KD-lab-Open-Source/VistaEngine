...
//			ScriptParser
///////////////////////////////////////////////////////////////////////////////////////
XPrmOArchive::XPrmOArchive(const char* fname, bool) :
buffer_(10, 1), 
binaryStream_(0)
{
...
{
    // до вызова closeStructure() должен быть вызван popBlock()
...
bool XPrmIArchive::openStruct (const char* name, const char* nameAlt, const char* typeName) {
	...
	if (exists) {
		if (! isContainer ()) {
			// если не внутри контейнера:
			// пытаемся найти элемент "name" в текущем блоке
