...
#define TLN_BEFORESELCHANGED	    (TLN_FIRST-30)			// before any selection change
#define TLN_AFTERSELCHANGED			(TLN_FIRST-31)			// after selection changed

#define TLN_MCLICK			        (TLN_FIRST-32)			// after selection changed
...
protected:
	...
	LRESULT	Notify( DWORD dwMessage, CTreeListItem* pItem, int iCol, int iMouseButton = MK_LBUTTON);
