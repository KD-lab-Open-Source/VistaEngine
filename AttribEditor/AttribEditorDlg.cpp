...
BOOL CAttribEditorDlg::OnInitDialog()
{
    ...
    if(rootNode_)
        ...
        attribEditor_.attachSerializer(serializeable_);
    else
        xassert(0);
...
bool CAttribEditorDlg::edit(Serializer serializeable, HWND hwndParent, const TreeControlSetup& treeControlSetup, const char* okLabel, const char* cancelLabel)
{
	okLabel_ = okLabel;
