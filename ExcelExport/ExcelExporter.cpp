...
#define _NO_EXCEL_EXPORT_AUTOMATIC_LINK_
...
public:
	...
	int addSheet(const wchar_t* name);
	void setSheetName(const wchar_t* name);
    void beginSheet();
	void setCurrentSheet(int index);

	void setCellFormat(const Vect2i& pos, const char* format);
    void setCellText(const Vect2i& pos, const wchar_t* text);
	void setCellComment(const Vect2i& pos, const wchar_t* comment);
    void setCellFloat(const Vect2i& pos, float value);

	void addHyperlink(const Vect2i& pos, const char* address, const char* subAddress, const wchar_t* cellText, const wchar_t* tipText);
...
void ExcelExporterImpl::setCellComment(const Vect2i& pos, const wchar_t* comment)
{
	using namespace Excel;
...
void ExcelExporterImpl::setCellText(const Vect2i& pos, const wchar_t* text)
{
	using namespace Excel;
    int line = pos.y + 1;
    int column = pos.x + 1;
...
int ExcelExporterImpl::addSheet(const wchar_t* name)
{
...
void ExcelExporterImpl::setSheetName(const wchar_t* name)
{
	sheet_->Name = name;
}

void ExcelExporterImpl::addHyperlink(const Vect2i& pos, const char* address, const char* subAddress, const wchar_t* cellText, const wchar_t* tipText)
{
...
//	void read(TreeNode* node);
	...
	const wchar_t* getCellText(const Vect2i& pos) {
