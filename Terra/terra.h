...
//const int SIZE_GEO_PALETTE=MAX_GEO_SURFACE_TYPE*3; // 3-��� RGB
const int SIZE_DAM_PALETTE=MAX_DAM_SURFACE_TYPE*4; // 3-��� RGB

//const int MAX_SURFACE_LIGHTING =128; //������������ ������������ ����������� �� 0 �� 127
									 //������� ��� �������������� Geo-0 ��� Dam-1

const int VX_FRACTION=5; // 5 ������� ��� - ����� ������� (����6)
...
const int MAX_VX_HEIGHT=((1<<(VX_FRACTION + 9))-1);//��� 0x3fff (512)
