...
struct elementGeoBreak {
	...
	//			vMap.dig(vMap.XCYCL(x_cur>>16), vMap.YCYCL((y_cur>>16)), 6);
	...
	//				vMap.dig(vMap.XCYCL((x_cur + stepdy*k)>>16), vMap.YCYCL((y_cur-stepdx*k)>>16), 6);
	//				vMap.dig(vMap.XCYCL((x_cur - stepdy*k)>>16), vMap.YCYCL((y_cur+stepdx*k)>>16), 6);
	//			}
	//		}
	//	}
	...
	//				vMap.dig(vMap.XCYCL(x_cur>>16), vMap.YCYCL(y_cur>>16), 6);
	//				for(int k=1; k<width; k++){
	//					//vMap.dig(vMap.XCYCL((x_cur>>16)-k), vMap.YCYCL(y_cur>>16), 6);
	//					//vMap.dig(vMap.XCYCL((x_cur>>16)+k), vMap.YCYCL(y_cur>>16), 6);
	//					vMap.dig(vMap.XCYCL((x_cur + stepdy*k)>>16), vMap.YCYCL((y_cur-stepdx*k)>>16), 6);
	//					vMap.dig(vMap.XCYCL((x_cur - stepdy*k)>>16), vMap.YCYCL((y_cur+stepdx*k)>>16), 6);
	//				}
