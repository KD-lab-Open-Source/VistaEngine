...
struct ColorQuantizer {
	...
	void setPaletteSize(unsigned int size){
		...
		pPalette=new sColor4c[size];
		paletteSize=size;
	}
	void setPalette(sColor4c* _pPalette, unsigned int _size){
	...
	inline unsigned char findNearestColor(sColor4c color){
