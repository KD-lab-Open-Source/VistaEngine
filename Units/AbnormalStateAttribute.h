...
struct UnitColor
{
	...
	UnitColor(Color4c color_, bool isBrightColor_) : color(color_), isBrightColor(isBrightColor_) {}
...
public:
	...
	bool hasDeathAttribute() const { return deathAttribute_ != 0; }
...
public:
	...
	bool freezeAttack() const { return freezeAttack_; }
