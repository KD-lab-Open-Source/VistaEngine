...
class GenericObject3dxNode : public StringIndexBase
{
	const char* modelName_;
public:
	GenericObject3dxNode(const char* model = 0) : StringIndexBase() { modelName_ = model; }
	void setName(const char* model) { modelName_ = model; }
