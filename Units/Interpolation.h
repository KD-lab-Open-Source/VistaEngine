...
public:
	...
	const T& prevValue() const { return x_[0]; } //���������� ���������
	const T& currValue() const { return x_[1]; } //��������� �� ������� ���������� �����
...
{
public:
	void operator()(BaseGraphObject* cur,Se3f p[2])
	{
...
{
public:
	void operator()(BaseGraphObject* cur,float p[2])
	{
		xassert(0);
	}
};
...
{
public:
	void operator()(BaseGraphObject* cur,Vect2f p[2])
	{
		xassert(0);
	}
};
...
{
public:
	void operator()(BaseGraphObject* cur,sColorInterpolate p[2])
	{
...
public:
	...
	void operator()(BaseGraphObject* cur, int node_index)
	{ 
		if(update_)
		{
...
public:
	...
	void operator()(BaseGraphObject* cur,eAxis axis)
	{ 
		if(update_)
		{
...
public:
	...
	void operator()(BaseGraphObject* cur,int animationGroup)
	{ 
		if(update_)
		{
