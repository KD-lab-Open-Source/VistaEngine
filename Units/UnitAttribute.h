...
{
	SHOOT_WHILE_IN_TRANSPORT	= 1,				///< ����� �������� ����� ����� � ����������

	SHOOT_WHILE_LYING			= MODE_CRAWL >> 4,	///< ����� �������� ����� �����
	SHOOT_WHILE_ON_ALL_FOURS	= MODE_GRABBLE >> 4,///< ����� �������� ����� ������ �� ��������
	SHOOT_WHILE_STANDING		= MODE_WALK >> 4,	///< ����� �������� ����� �����

	SHOOT_WHILE_CRAWLING		= MODE_CRAWL,		///< ����� �������� ����� ������
	SHOOT_WHILE_GRABBLING		= MODE_GRABBLE,		///< ����� �������� ����� ��� �� ���������
	SHOOT_WHILE_MOVING			= MODE_WALK,		///< ����� �������� ����� ���
	SHOOT_WHILE_RUNNING			= MODE_RUN			///< ����� �������� ����� �����
};
...
public:
	...
	const ShowChangeSettings* getShowChangeSettings(int idx) const; //������ � ParameterTypeTable
	LocString tipsName;
	...
	const AnimationChain* animationChain(ChainID chainID, int counter = -1, const AbnormalStateType* astate = 0, MovementState movementState = MovementState::DEFAULT, WeaponAnimationType weapon = WeaponAnimationType("")) const; // �� ��������� - ���������
...
private:
	...
	AbnormalStateAttribute waterEffect; // ������������ � AttributeCache, ����� ������
	AbnormalStateAttribute lavaEffect; // ������������ � AttributeCache, ����� ������
	AbnormalStateAttribute iceEffect; // ������������ � AttributeCache, ����� ������
	AbnormalStateAttribute earthEffect; // ������������ � AttributeCache, ����� ������
