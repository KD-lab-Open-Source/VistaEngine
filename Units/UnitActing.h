...
public:
	...
	bool startProduction(const AttributeBase* producedUnit, UnitSquad* shippedSquad, int counter, bool restartFromQueue = false); // true - ������������ ��������
	...
	float targetRadius();
	bool fireDistanceCheck() const; // true - ���� ����(�) � �������� �����.
...
protected:
	...
	UnitLink<UnitInterface> targetUnit_;  // ���� ��� �����
	Vect3f targetPoint_;  // ����� ��� �����
	bool hadTargetUnit_;

	UnitLink<UnitInterface> specialTargetUnit_;  // ���� ��� �����
	Vect3f specialTargetPoint_;  // ����� ��� �����

	bool targetPointEnable; // ������� ����� �����?
	bool specialTargetPointEnable; // ������� ����� �����?
	bool attackTargetUnreachable_;

	UnitLink<UnitBase> noiseTarget_; // ���������� �������� ����
