...
class CrashBody : public BaseUniverseObject
{
public:
...
public:
	...
	CrashModel3dx(const Vect3f& deltaPos, vector<cSimply3dx*>& debrises, const ExplodeProperty& property_, const EffectAttribute* effect, float explodeFactor, float liveTime, bool enableFantomMode = false);
	~CrashModel3dx();
...
private:
	SwapVector<CrashModel3dx*> crashModels;
};
