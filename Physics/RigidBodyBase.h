...
public:
	...
	// States
	bool groundColliding() const { return (colliding_ & GROUND_COLLIDING) != 0; } // ������������, ����� �� �����
	bool waterColliding() const { return (colliding_ & WATER_COLLIDING) != 0; } // ������������, ����� �� ����
	// Debug info
	virtual void show();
