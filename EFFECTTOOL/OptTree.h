...
IX_K_WIND_MIN			=65,
IX_Generate_time		= 66, 
IX_Strip_width_begin	= 67,
IX_strip_width_time		= 68,
IX_strip_length			= 69,
IX_fade_time			= 70,
IX_lighting_amplitude	= 71, 
IX_Lighting_count		= 72,
IX_Particle_LifeTime	= 73,
IX_EmitterScale			= 74, 
IX_Texture2				= 75,
IX_ModelScale			= 76,
IX_Turn					= 77,
...
IX_TextureCount			= 87,
IX_SizeByTexture		= 88, 
IX_ScaleEffectWithModel	= 89, 
IX_Texture1				= 90, // Номера с 90 по 99 зарезервированы
IX_VelNoise				= 100,
IX_VelProp				= 101,
IX_DirNoise				= 102,
IX_DirProp				= 103,
IX_IsVelNoiseOther		= 104,
IX_VelNoiseOther		= 105,
IX_IsDirNoiseOther		= 106,
IX_DirNoiseOther		= 107,
IX_LightOnObjects		= 108,
IX_OrientedByDirection	= 109,
IX_BlockX				= 110,
IX_BlockY				= 111,
IX_BlockZ				= 112,
IX_NoiseReplace			= 113,
...
IX_SoftSmoke			= 120,
IX_K_WIND_MAX			= 121,
IX_IgnoreParticleRate	= 122,
IX_OrientedToCenter		= 123,
IX_OrientedToAxis		= 124,
};					
...
public:
	CTreeListItem* InsertItem(const char* cap,DWORD dat,CTreeListItem* item);
...
public:
	bool SelIs(int Ix);
	bool ActEmitIsInt();
	bool NeedGraphSize(bool &sel);
	bool NeedGraphAngleVel(bool &sel);
	bool NeedGraphGravitation(bool &sel);
	bool NeedGraphVelMul(bool &sel);
	bool NeedGraphVelocity(bool &sel);
	bool NeedGraphParticlesCount(bool &sel);
	bool NeedGraphDeltaVel(bool &sel);
	bool NeedGraphDeltaSize(bool &sel);
	bool NeedGraphDeltaTimeLife(bool &sel);
	bool NeedGraphEmitterScale(bool &sel);
	bool NeedGraphU_Vel(bool &sel);
	bool NeedGraphV_Vel(bool &sel);
	bool NeedGraphSize2(bool &sel);
	bool NeedGraphHeight(bool &sel);
