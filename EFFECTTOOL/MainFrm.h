...
//	CToolBar    m_wndToolBarTools;
	...
	void OnUpdateToolsEnableOverDraw(CCmdUI* pCmdUI);
	void OnTools();
	void OnFindCenter();
	void OnToolUndo();
	void OnLoadWorld();
...
public:
	...
	afx_msg void OnToolsTarget();
	afx_msg void OnToolsColor();
	afx_msg void OnToolsEnableOverDraw();
	afx_msg void OnUpdateToolsTarget(CCmdUI* pCmdUI);
	afx_msg void OnToolsEnablePreset();
};
