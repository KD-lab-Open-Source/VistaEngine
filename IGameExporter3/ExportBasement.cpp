...
void ExportBasement::Export(IVisMesh* pobject_,IVisNode* node,Matrix3 root_node_matrix)
{
	pobject=pobject_;

	Matrix3 m_node=pRootExport->cache.GetWorldTM(node,pRootExport->GetBaseFrameMax());
