...
class cWater;
class cTemperature : public BaseGraphObject
{
public:
	cTemperature();
	~cTemperature();
	...
	cTexture* textureBump() { return textureBump_; }
	cTexture* textureCleft() { return textureCleft_; }
...
protected:
	...
	cTexture* texture_;
	cTexture* textureBump_;
	cTexture* textureAlpha_;
	cTexture* textureCleft_;
	cWater* pWater;
