...
class cWaves : public cBaseGraphObject
{
public:
	EffectKey* pena;
	cWater* pWater;
	...
	struct GRID_DATA
	{
		...
		GRID_DATA():mode(W_earth), bord(NULL){}
	};
...
public:
	...
	void ShowInfo(sColor4c& color = sColor4c(128,128,255));
...
class cFixedWavesContainer : public cBaseGraphObject
{
