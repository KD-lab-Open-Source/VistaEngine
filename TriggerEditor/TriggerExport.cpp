...
REGISTER_ENUM_ENCLOSED(TriggerChain, LOGIC_TRIGGER, "���������� �������")
REGISTER_ENUM_ENCLOSED(TriggerChain, INTERFACE_TRIGGER, "������������ �������")
REGISTER_ENUM_ENCLOSED(TriggerChain, IGNORE_PAUSE, "������������ ������� � ������������� �����")
REGISTER_ENUM_ENCLOSED(TriggerChain, NO_CHECK, "�������� ��������� (������ ��� �������� ����!!!)")
...
void Condition::serialize(Archive& ar) 
{
	if(ar.isEdit())
		...
		ar.serialize(inverted_, "inverted", "�������������");
...
void TriggerLink::serialize(Archive& ar) 
{
	...
	if(ar.isEdit()){
		...
		ar.serialize(colorType_, "color", "����");
	ar.serialize(autoRestarted_, "type", "���");
...
void Trigger::serialize(Archive& ar) 
{
	...
	if(!ar.serialize(color_, "color", "����")){ // CONVERSION
		int internalColor_;
	...
	if(!ar.isEdit() || isContext_){
		ar.serialize(unitsPerQuant_, "unitsPerQuant", "������������ ������ �� ����� ��� ����������� �������");
		ar.serialize(extendedScan_, "extendedScan", "������������ ��������� �� ���� �������");
	}
	xassert("BUG: �������� � ������������ ���������!" && (!condition || condition->numRef() == 1));
	ar.serialize(condition, "condition", "<�������");
	xassert("BUG: �������� � ������������ ���������!" && (!action || action->numRef() == 1));
	...
	ar.serialize(randomizeOutcomingLinks_, "randomizeOutcomingLinks", "��������������� ��������� �������");
	ar.serialize(breakWhenActivate_, "breakWhenActivate", "������������ ��� ��������� (�����)");
...
void TriggerChain::serializeProperties(Archive& ar) 
{
	if(ar.isInput() && !ar.isEdit()){
		...
		ar.serialize(ignorePause, "ignorePause", "������������ �����");
		ar.serialize(checkDeterminism, "checkDeterminism", "��������� �� �������������");
		if(checkDeterminism)
			checkType_ = LOGIC_TRIGGER;
		else if(ignorePause)
	...
	ar.serialize(checkType_, "checkType", "��� �������� ��������");
}
